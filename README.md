...
* Fully Connected layer - Traditional neural layers, used at the end stem of the neural network. Not used these days due to the staggering amount of parameters it uses
...
![ResNet](http://cv-tricks.com/cnn/understand-resnet-alexnet-vgg-inception/)\
